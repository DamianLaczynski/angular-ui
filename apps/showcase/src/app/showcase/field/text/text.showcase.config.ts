...
const TEXT_CONTROL_DEFS: SharedControlDef[] = [
  {
    key: 'label',
    label: 'Label',
    type: 'text',
...
const TEXT_FORM_CONTROLS = toDrawerFormControls(TEXT_CONTROL_DEFS);
...
export const TEXT_SHOWCASE_CONFIG: ShowcaseConfig = {
  ...
  controls: toShowcaseControls(TEXT_CONTROL_DEFS),
};
