...
import { TEXT_DRAWER_CONFIGS } from './text.showcase.config';
import { TextInteractiveComponent } from './text.interactive';
  ...
  template: `
    <div class="showcase showcase--responsive showcase__with-toc">
      ...
      <div class="showcase-content">
        <app-showcase-header title="Text" />
        <p class="showcase__description">
          Text input component based on Fluent 2 Design System. Supports variants (filled,
          filled-gray, filled-lighter, underlined), sizes, and states like disabled, readonly,
          required. Use for single-line text input in forms.
        </p>
            ...
            @for (size of sizes; track size) {
              <div class="showcase__item">
                ...
                <ui-text
                  ...
                  [helpText]="'This is a ' + size + ' text field'"
                />
              </div>
            }
          </div>
...
export class TextShowcaseComponent {
  ...
  sizeDrawerFormConfig = TEXT_DRAWER_CONFIGS.size;
  variantsDrawerFormConfig = TEXT_DRAWER_CONFIGS.variants;
  statesDrawerFormConfig = TEXT_DRAWER_CONFIGS.states;
